...
\addbibresource{note-emp-proc-rates.bib}

\title{Empirical Processes: Probability Inequalities and Rates of Convergence}
\author{Ahnaf Rafi}
\date{\today}
...
\input{sections/prob-ineq-prelim.tex}

\printbibliography

\appendix

\input{sections/appendix-prob-ineq-prelim.tex}
\input{sections/appendix-symmetrization.tex}
\input{sections/appendix-miscellany.tex}
